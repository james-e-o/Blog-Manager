...
const Header = () => {
  ...
  return (
    <header className={offline? "header active":"header"}>
       ...
       <div className='svg' onClick={()=>setMenuActive(!menuActive)}>
       ...
       <div className={menuActive? "toggle-menu":"toggle-menu toggle-off"}>
              <div className='menu-header'>               
                <svg  xmlns="http://www.w3.org/2000/svg" onClick={()=>setMenuActive(!menuActive)} fill='gray' height="38" viewBox="0 -960 960 960" width="38"><path d="m249-207-42-42 231-231-231-231 42-42 231 231 231-231 42 42-231 231 231 231-42 42-231-231-231 231Z"/></svg>
              </div>
          </div>
    </header>
  )
