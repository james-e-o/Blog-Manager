...
export const Signup = () => {
  return (
    <div className='signup'>
      ...
      <button style={{padding: '8px 70px',fontSize:'15px',color:'white', background:'slateblue', border:'none', borderRadius:'4px',marginTop:'15px'}}>Sign up</button>
    </div>
  )
}
export const Signin = () => {
  return (
    <div className='signin'>
      ...
      <div className='login-options'>
          ...
          <div style={{fontSize:'14px',fontWeight:'light', marginTop:'10px',padding:'5px', color:'#6559ac'}}>Create Account</div>
